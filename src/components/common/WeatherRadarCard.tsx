...
export const WeatherRadarCard: React.FC<WeatherRadarCardProps> = ({
  ...
  return (
    <div
      className={clsx(
        'card-premium overflow-hidden border transition-all duration-300 card-interactive',
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded bg-sky-100 text-sky-800 text-[10px] font-extrabold tracking-wider shrink-0">
                LIVE OPEN-METEO
              </span>
            </div>
        ...
        >
          ...
          {onEmergencyPreBook && (
            <button
              onClick={onEmergencyPreBook}
              className={clsx(
                'w-full sm:w-auto px-4 py-2.5 rounded-xl font-extrabold text-xs shadow-md transition-all flex items-center justify-center gap-2 shrink-0 cursor-pointer',
                isEmergency
