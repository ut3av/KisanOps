    ...
    <div className="space-y-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs text-left">
            <thead className="bg-surface-50 text-slate-600 font-bold uppercase tracking-wider text-[10px] border-b border-slate-200">
              <tr>
                <th className="py-3 px-4">Identifier / Asset</th>
                <th className="py-3 px-4">Operating Hub</th>
                <th className="py-3 px-4 text-center">Status</th>
                <th className="py-3 px-4 text-center">Health Score</th>
                <th className="py-3 px-4 text-center">Engine Hours</th>
                <th className="py-3 px-4 text-center">Next Service</th>
                <th className="py-3 px-4 text-right">Tariff (₹/hr)</th>
                  ...
                  <tr key={machine.id} className="hover:bg-slate-50 transition-colors">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <div className="font-extrabold text-slate-900">{machine.brand} {machine.model}</div>
                    ...
                    <td className="py-3 px-4 text-center">
                      <span className={clsx('badge-status border text-[10px]', getStatusBadgeClass(machine.status))}>
                        {machine.status}
                      </span>
                    </td>
      ...
      {selectedMachine && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 shadow-2xl border border-slate-100 my-8 space-y-4">
