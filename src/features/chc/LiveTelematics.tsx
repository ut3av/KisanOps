...
export const LiveTelematics: React.FC = () => {
  usePageTitle(
    'Live Machine Tracking & Fuel Status',
    'Real-time GPS coordinates, tractor speed, diesel usage, and engine health.'
  );
    ...
    return (
      <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 shadow-subtle space-y-4 max-w-lg mx-auto my-8">
        ...
        <p className="text-xs text-slate-500 max-w-md mx-auto leading-relaxed">
          No machines found in your hub yet. Add your tractors or load sample machines to see live GPS tracking and diesel usage.
        </p>
        <button
        ...
        >
          ...
          <span>Load Sample Machines</span>
        </button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      {/* Header with Live Machine Tracking Status & Fuel Leak Controls */}
      <div className="bg-white border border-slate-200/90 rounded-3xl p-5 sm:p-6 shadow-subtle flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">
              Live Machine Fleet & GPS Tracking
            </h1>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Real-time tracking from tractor GPS and engine sensors.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <span>Connect Machine GPS Device</span>
          </button>
          ...
          >
            ...
            <span>
              {simulationState.isFuelAnomalyActive ? 'Diesel Leak Alert Active (+17%)' : 'Test Diesel Leak Alert'}
            </span>
          </button>
          ...
          >
            ...
            <span>{isSimulating ? 'Pause Live Signal' : 'Resume Live Signal'}</span>
          </button>
        </div>
      </div>
