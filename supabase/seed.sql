...
-- 1. Seed Profiles (UUIDs: 8-4-4-4-12 hexadecimal digits)
...
VALUES 
('c0000001-0000-0000-0000-000000000001', 'Sehore Agri Centre #01', 'CHC-MP-SEH-01', '22222222-2222-2222-2222-222222222222', 'Bilkisganj Road', 'Sehore', 'Madhya Pradesh', 23.2032, 77.0844, '+91 98930 77122', 'sehore01@kisanops.in', 14, 11),
('c0000002-0000-0000-0000-000000000002', 'GreenFields CHC Hub', 'CHC-MP-BHP-03', '44444444-4444-4444-4444-444444444444', 'Phanda Kalan', 'Bhopal', 'Madhya Pradesh', 23.2394, 77.2655, '+91 98260 55144', 'greenfields.bhopal@kisanops.in', 22, 14),
('c0000003-0000-0000-0000-000000000003', 'Kisan Seva Kendra Raisen', 'CHC-MP-RSN-02', NULL, 'Salamadpur', 'Raisen', 'Madhya Pradesh', 23.3315, 77.7812, '+91 94250 11988', 'raisen02@kisanops.in', 10, 7)
...
VALUES 
('f0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'Ramesh Kumar Wheat Farm (Khasra 142/2)', 'Bilkisganj', 'Sehore', 'Madhya Pradesh', 23.1845, 77.0982, 8.0, 'Tube well + Canal', 'Deep Black Vertisol')
...
VALUES 
('fc000001-0000-0000-0000-000000000001', 'f0000001-0000-0000-0000-000000000001', 'Wheat (Sharbati Gold)', 'Rabi', 'Pre-harvest', CURRENT_DATE + INTERVAL '10 days')
ON CONFLICT (id) DO UPDATE SET crop_name = EXCLUDED.crop_name;
...
VALUES 
('d0000001-0000-0000-0000-000000000001', 'c0000001-0000-0000-0000-000000000001', 'JD-HARV-07', 'HARVESTER', 'John Deere', 'W70 Combine Harvester with Straw Walker', 100, 'AVAILABLE', 980.00, 94, 1243.8, 23.1950, 77.0910, 'Raju Verma', 4.9, 4.9, 142),
('d0000002-0000-0000-0000-000000000002', 'c0000001-0000-0000-0000-000000000001', 'MH-575-01', 'TRACTOR', 'Mahindra', '575 DI Sarpanch Plus 4WD', 47, 'AVAILABLE', 450.00, 91, 2180.5, 23.2045, 77.0850, 'Suresh Meena', 4.7, 4.8, 280),
('d0000003-0000-0000-0000-000000000003', 'c0000001-0000-0000-0000-000000000001', 'SW-744-02', 'TRACTOR', 'Swaraj', '744 FE Multi-Speed PTO', 48, 'AVAILABLE', 460.00, 88, 1890.0, 23.2010, 77.0810, 'Mukesh Lodhi', 4.8, 4.7, 195),
('d0000004-0000-0000-0000-000000000004', 'c0000002-0000-0000-0000-000000000002', 'SN-HARV-12', 'HARVESTER', 'Sonalika', 'Tiger Combine Harvester 4x4', 110, 'AVAILABLE', 950.00, 96, 610.2, 23.2410, 77.2680, 'Anil Malviya', 4.9, 4.9, 78)
...
VALUES 
('e0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 742, 'Good', 8000.00, 0.00, 96, 92, 94)
ON CONFLICT (farmer_id) DO UPDATE SET credit_score = EXCLUDED.credit_score;
